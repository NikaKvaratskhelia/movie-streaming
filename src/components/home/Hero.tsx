        ...
        >
          ...
          <div className="flex mt-[40%] lg:mt-[20%] justify-center px-4">
            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6">
              ...
              <button className="flex items-center justify-center w-full sm:w-[223px] h-[56px] lg:h-[76px] bg-[#FF0000] text-white text-[18px] lg:text-[24px] font-bold gap-[10px]">
                Watch Now <span>▶</span>
              </button>

              <button className="flex items-center justify-center w-full sm:w-[223px] h-[56px] lg:h-[76px] border-[3px] border-[#FF0000] text-white text-[18px] lg:text-[24px] font-bold">
                Watch Later
              </button>
          ...
          <div className="w-full p-6 sm:p-10 lg:p-[10%] flex justify-start">
            <div className="max-w-2xl text-white">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-4 text-[14px] lg:text-[16px] text-black font-bold">
                ...
                <span className="h-[36px] lg:h-[44px] bg-white rounded-full px-3 lg:px-4 flex items-center">
                  {movie.yearPublished}
                </span>
